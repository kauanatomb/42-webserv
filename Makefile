...
CXX = c++
CXX_FLAGS = -Wall -Wextra -Werror -std=c++98 -I includes -pedantic
INFILE = src/main.cpp src/config/ConfigLoader.cpp src/config/Tokenizer.cpp \
			...
			src/resolver/ConfigResolver.cpp src/resolver/RuntimeServer.cpp \
			src/resolver/RuntimeLocation.cpp
